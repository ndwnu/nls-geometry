...
class GeoJsonLineStringCoordinateMapperTest {
    ...
    void map_ok() {
        ...
        assertEquals(List.of(coordinateAListDouble, coordinateBListDouble), geoJsonLineStringCoordinateMapper.map(lineString));
