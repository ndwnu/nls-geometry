...
class DistanceCalculatorIT {
    ...
    public static Stream<Arguments> calculateDistance_okArgumentsProvider() {
        return Stream.of(
                ...
                Arguments.of(4.908418, 52.363990, 148.95011124124488)
        );
    }
    ...
    void calculateDistance_ok(double sourceX, double sourceY, double expectedDistance) {
        Coordinate sourceCoordinate = new Coordinate(sourceX, sourceY);
        ...
        double result = distanceCalculator.calculateDistance(sourceCoordinate, targetLineString);
